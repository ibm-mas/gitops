...
| `Service` | `ibm-nginx-svc` backend reference (pre-existing CP4D service, referenced by the Route) | CP4D instance namespace | When `cpd_public_route_enabled` is true | `cluster_admin_role` |
